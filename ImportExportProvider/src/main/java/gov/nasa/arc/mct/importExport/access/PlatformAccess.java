...
/**
 * The <code>PlatformAccess</code> class is used to inject an instance of 
 * <code>Platform</code> using declarative services. 
 *
 */
public class PlatformAccess {
	...
	public void releasePlatform(Platform aPlotform) {
		platform.set(null);
	}
}
