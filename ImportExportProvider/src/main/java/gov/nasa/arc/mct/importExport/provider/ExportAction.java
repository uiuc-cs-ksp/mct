...
public class ExportAction extends ContextAwareAction implements
	...
	public void actionPerformed(ActionEvent e) {
		...
		File file = selectFile(currentContext.getWindowManifestation());

		if (file != null) {
			List<AbstractComponent> selectedComponents = 
                    new ArrayList<AbstractComponent>();
			
			// find the selected components
			Collection<View> manifestations = currentContext.getSelectedManifestations();
			for (View manifestation : manifestations) {
				if (manifestation != null) {
					selectedComponents.add(manifestation.getManifestedComponent());
				}
			}
	...
	private void buildProgressBar() {
		Window activeWindow = FrameUtil.getFrameForComponent(currentContext
