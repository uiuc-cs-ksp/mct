...
public class JUnitDoubleDataDouble extends TestCase {
	public void testGrow() {
		DoubleData data = new DoubleDataDouble(4);
		data.add(0);
	...
	public void testAddOutOfRange() {
		DoubleData data = new DoubleDataDouble();
	...
	public void testAddDoubleData() {
		DoubleDataDouble data = new DoubleDataDouble(4);
		data.add(0);
		assertEquals(1, data.getLength());
		DoubleDataDouble data2 = new DoubleDataDouble();
	...
	public void testAddDoubleDataWithCycle() {
		...
		data.add(0);
		assertEquals(1, data.getLength());
		DoubleDataDouble data2 = new DoubleDataDouble(4);
		data2.add(1);
		data2.add(2);
		data2.add(3);
		data2.removeFirst(2);
	...
	public void testPrependMultipleWithCycle2() {
		...
		DoubleData data2 = new DoubleDataDouble(4);
		data2.add(0);
		data2.add(1);
		data2.add(2);
		data2.add(3);
	...
	public void testPrependDoubleDataOutOfRange() {
		DoubleData data = new DoubleDataDouble(4);
		data.add(0);
		DoubleData d = new DoubleDataDouble();
		d.add(2);
		d.add(3);
		d.add(4);
	...
	public void testInsertCloseToHead() {
		for(int pad = 0; pad < 8; pad++) {
			DoubleData data = new DoubleDataDouble(8);
			for(int i = 0; i < pad; i++) {
				data.add(-1);
			}
	...
	private DoubleData init(int cap, int off, int len) {
		DoubleData data = new DoubleDataDouble(cap);
		for(int i = 0; i < off; i++) {
			data.add(0);
		}
	...
	public void testCopyFromDoubleData() {
		DoubleData data = new DoubleDataDouble(8);
		DoubleData data2 = new DoubleDataDouble(8);
		for(int i = 0; i < 8; i++) {
			data.add(i);
			data2.add(i + 8);
		}
