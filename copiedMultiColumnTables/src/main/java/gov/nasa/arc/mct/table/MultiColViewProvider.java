 ...
 */
public class MultiColViewProvider extends AbstractComponentProvider {
	...
	public MultiColViewProvider() {		
		...
		viewInfos = Arrays.asList(
				new ViewInfo(MultiColView.class, MultiColView.VIEW_ROLE_NAME, "gov.nasa.arc.mct.table.view.TableViewRole", ViewType.OBJECT,
				...
				new ViewInfo(MultiColView.class, MultiColView.VIEW_ROLE_NAME, "gov.nasa.arc.mct.table.view.TableViewRole", ViewType.EMBEDDED,
						new ImageIcon(getClass().getResource("/images/alphaViewButton-OFF.png")),
						new ImageIcon(getClass().getResource("/images/alphaViewButton-ON.png"))));
	}
