 ...
 *
 */
public class NonTimeColorPalette {
//	private static final ResourceBundle BUNDLE = 
//        ResourceBundle.getBundle(NonTimeColorPalette.class.getName().substring(0, 
//        		NonTimeColorPalette.class.getName().lastIndexOf("."))+".Bundle");
	...
	public static Color getColor(int i) {
		...
		Color c = UIManager.getColor(String.format("PlotColor.Color%d", (i+1)));
		if (c != null) return c;
