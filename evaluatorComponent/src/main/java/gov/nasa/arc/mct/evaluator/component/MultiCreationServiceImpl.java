...
import gov.nasa.arc.mct.evaluator.api.MultiCreationService;
import gov.nasa.arc.mct.services.component.ComponentRegistry;

import java.util.concurrent.atomic.AtomicReference;

public class MultiCreationServiceImpl implements MultiCreationService {
	...
	public void setComponentRegistry(ComponentRegistry registry) {
		MultiCreationServiceImpl.registry.set(registry);
	}
