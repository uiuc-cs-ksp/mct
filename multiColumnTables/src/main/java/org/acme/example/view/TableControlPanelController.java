...
import javax.swing.table.TableColumnModel; //redundant maybe

import org.acme.example.view.AlexTable.TableModelTest;
...
public class TableControlPanelController extends TableSettingsController {
	...
	private AlexTable table; //possibly not the appropriate class
	private TableModelTest model;

	private AlexView manifestation;
	 ...
	 */
	public TableControlPanelController(AlexView manifestation, AlexTable table, TableModelTest model) {
