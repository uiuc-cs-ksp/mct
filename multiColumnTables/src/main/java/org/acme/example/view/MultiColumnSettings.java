...
/**
 * Holds the settings for a Multi Column view.
 * 
 * This class is based on a copy-paste of TableSettings
 */
public class MultiColumnSettings {
	
	final static Logger logger = LoggerFactory.getLogger(MultiColumnSettings.class);
...
//	private static final String ROW_SEPARATOR = "/";
	 ...
	 */
	public String getValue(MultiColumnSettings.AvailableSettings setting) {
		switch (setting) {
	 ...
	 */
	public void setValue(MultiColumnSettings.AvailableSettings setting, String value) {
		switch (setting) {
		case COLUMN_ORDER: {
			columnOrder = value;
			break;
