...
import org.acme.example.view.TimeFormat.DateFormatItem;
import static org.acme.example.view.ConstraintBuilder.hbox;
...
//		mgr.hide(ENUMERATION_CONTROLS, enumeration.getModel().getSize()==0);
		...
		mgr.hideIfOthersHidden(rowColumnFormattingPanel, rowHeightSpinner, columnWidthSpinner, 
				transposeTableButton, rowHeaderAlignLeft, 
