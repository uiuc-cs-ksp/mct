...
import org.acme.example.view.AlexView;
...
public class ExampleComponentProvider extends AbstractComponentProvider {
	...
	private final ComponentTypeInfo chillComponentType;
	...
	public ExampleComponentProvider() {
		...
		chillComponentType = new ComponentTypeInfo(
				bundle.getString("chill_display_name"),
				bundle.getString("chill_description"),
				ChillComponent.class);
	}
	...
	public Collection<ComponentTypeInfo> getComponentTypes() {
		...
		return Arrays.asList(exampleComponentType, telemetryComponentType, chillComponentType);
	}
	...
	public Collection<ViewInfo> getViews(String componentTypeId) {
		...
		if (componentTypeId.equals(ExampleComponent.class.getName())) {
			return Arrays.asList(
					...
					new ViewInfo(AlexView.class, bundle.getString("AlexViewName"), ViewType.OBJECT)
			);
		}
		//later, maybe a more sophisticated set of what gets multicol table view and what doesn't. 
		if(!(componentTypeId.equals(TelemetryComponent.class.getName()))) {
			return Arrays.asList(new ViewInfo(AlexView.class, bundle.getString("AlexViewName"), ViewType.OBJECT)); 
		} else {
