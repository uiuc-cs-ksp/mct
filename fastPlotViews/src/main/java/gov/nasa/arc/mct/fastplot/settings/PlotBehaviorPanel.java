...
import gov.nasa.arc.mct.fastplot.view.PlotSettingController;
...
public class PlotBehaviorPanel extends PlotSettingsPanel {
    ...
    private final static Logger logger = LoggerFactory.getLogger(PlotBehaviorPanel.class);
	 ...
	 * ================================================
	 */
	public PlotBehaviorPanel(PlotViewManifestation plotMan) {
